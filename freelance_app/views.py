...
def my_orders(request, pk=''):
    ...
    work_ready_list = list(Order.objects.filter(customer=customer).values_list('work_ready', flat=True))
    ...
    return render(request, 'my_orders.html', {'object_list': object_list, 'form': form})
