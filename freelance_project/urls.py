...
<<<<<<< HEAD
    ...
    # Все нижние Никитины
    path('freelancer/main_page/free_orders/chose/<int:pk>', update_offers),
    path('freelancer/main_page/my_works', freelancer_my_works, name='my_works'),
    path('freelancer/main_page/free_orders/refuse/<int:pk>', refuse_offer),
    path('freelancer/main_page/my_works/save_answer/<int:pk>', freelancer_my_works),
    path('customer/customer_main_page/my_orders/accept/<int:pk>', accept_order),
    path('customer/customer_main_page/my_orders/rate/<int:pk>', customer_main_page),
    path('customer/customer_main_page/my_orders/reject/<int:pk>', refuse_order),
    #новое
